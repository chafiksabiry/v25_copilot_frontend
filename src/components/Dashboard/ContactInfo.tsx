            ...
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <div className="flex flex-col items-center flex-1">
                <div className="w-[180px]">
                  <span className="block bg-[#25594B] text-green-200 py-1 rounded-full text-sm font-medium text-center">Qualified</span>
                </div>
                <div className="mt-2 text-white text-lg font-bold text-center">{contact.leadScore}/100</div>
                <div className="text-slate-300 text-xs text-center">Lead Score</div>
                <div className="mt-1 text-green-400 text-md font-bold text-center">{contact.value > 0 ? `$${contact.value.toLocaleString()}` : 'N/A'}</div>
                <div className="text-slate-300 text-xs text-center">Potential Value</div>
              </div>
            </div>
          </div>
        </div>
